...
<h1>상품 등록</h1>
	...
	<table class="table">
	<tr>
		<td>제품명</td><td><input type="text" name="prod_name"></td>
	</tr>
	<tr>
		<td>제품가격</td><td><input type="text" name="prod_price"></td>
	</tr>	
	<tr>
		<td>카테고리(대)</td><td><input type="text" name="prod_cat_big"></td>
	</tr>
	<tr>
		<td>카테고리(소)</td><td><input type="text" name="prod_cat_small"></td>
	</tr>
	<tr>
		<td rowspan=2>메인이미지</td><td><input type="file" name="main_imgpath" onchange="getFileName(this)"></td>
	</tr>
	<tr>
		<td><input type="text" id="mainimg" name="prod_main_imgpath"></td>
	</tr>
	<tr>
		<td rowspan=2>섬네일</td><td><input type="file" name="thumb_imgpath" onchange="getthumbFileName(this)"></td>
	</tr>
	<tr>
		<td><input type="text" id="thumbimg" name="prod_thumb_imgpath"></td>
	</tr>
	<tr>	
		<td rowspan=5>서브이미지</td><td><input type="file" name="sub_imgpath1" onchange="getSubFileName(this)"></td>
	</tr>
	<tr>
...
<table class="button">
		<tr>
			<td>
				...
				<a href="prodall.do"><input type="button" class="btn" value="취소"></a>
			</td>
		</tr>
	</table>
</form>
