...
public class ProductVO {
	...
	public ProductVO(String prod_name,String prod_price, String prod_amount,String prod_cat_big, String prod_cat_small, 
			String prod_main_imgpath,String prod_sub_imgpath,String prod_thumb_imgpath) {
	...
	public ProductVO(String prod_name) {
		this.prod_name = prod_name;
	}
